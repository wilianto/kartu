                            ...
                            <td colspan=3>
                                <table width="100%">
                                    ...
                                    foreach($data as $key => $detail){
                                        if($last_operator != $detail['username']){
                                            ?>
                                            <tr>
                                                <th colspan=3><?= $detail['username'] ?></th>
                                            </tr>
                                            <?php
                                        }
                                        ?>
                                        <tr><td><?= $detail['nama'] ?></td><td align="right"><?= $detail['total_qty'] ?></td></tr>
                                        <?php
                                        $last_operator = $detail['username'];
                                    }
                                    ?>
                                </table>
                            </td>
